...
| Endpoint         | Method | Description                                                                                      | Authentication | Request Example                                                                                              | Response Example                                                                                                                                                 |
|-------------------|--------|--------------------------------------------------------------------------------------------------|----------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| `/login`             | LoginPage        | Displays the login page.                                                                     |
| `/library`           | Homepage         | Displays the main library page. Contains nested routes for book operations.                  |
| `/library/add`       | BookPopup        | Opens a popup for adding a new book.                                                         |
| `/library/:id`       | BookPopup        | Opens a popup to view details of a specific book identified by `id`.                         |
| `/library/:id/edit`  | BookPopup        | Opens a popup for editing a specific book identified by `id`.                                |
| `/library/:id/delete`| ComfirmPopup     | Opens a confirmation popup for deleting a specific book identified by `id`.                  |
| `/categories`        | CategoryPage     | Displays the main categories page. Contains nested routes for category operations.           |
| `/categories/add`    | CategoryPopup    | Opens a popup for adding a new category.                                                     |
| `/categories/:id/edit`| CategoryPopup    | Opens a popup for editing a specific category identified by `id`.                            |
| `/categories/:id/delete`| ComfirmPopup  | Opens a confirmation popup for deleting a specific category identified by `id`.              |
